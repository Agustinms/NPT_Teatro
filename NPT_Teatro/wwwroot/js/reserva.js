...
function cargarDatatable() {
    dataTable = $("#tblReservas").DataTable({
        ...
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "email", "width": "25%" },
            { "data": "funcion.id", "width": "15%" },
            { "data": "cantEntradas", "width": "15%" },
            {
                "data": "id",
                "render": function (data) {
                    return `<div class="text-center">
                            ...
                            &nbsp;
                            <a onclick=Delete("/Admin/Reservas/Delete/${data}") class='btn btn-danger text-white' style='cursor:pointer; width:100px;'>
